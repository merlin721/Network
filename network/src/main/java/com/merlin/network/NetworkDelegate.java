...
public class NetworkDelegate {
    ...
    public <T> NetworkOption uploadPost(Class<T> className, String url, HashMap<String, ?> params, CallBack<T> callBack, String path,int i) {
        if (this.networkOption != null) {
            return this.networkOption.uploadPost(className, url, params, callBack, path,i);
        }
        return null;
    }
