...
import com.soyoung.component_base.widget.tablayout.utils.FragmentChangeManager;
...
public class SlideCommonTabLayout extends HorizontalScrollView implements ValueAnimator.AnimatorUpdateListener {
    ...
    private boolean mIndicatorSelectBoldEnable;
    private boolean mText_select_bold_enable;
    private boolean mIndicatorBounceEnable;
    private int mIndicatorGravity;

    private boolean mIsWidthMatch = false;
    ...
    public SlideCommonTabLayout(Context context) {
        this(context, null, 0);
    }

    public SlideCommonTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideCommonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectBoldEnable = ta.getBoolean(R.styleable.CommonTabLayout_tl_indicator_select_bold_enable, false);
        mText_select_bold_enable = ta.getBoolean(R.styleable.CommonTabLayout_tl_text_select_bold_enable, false);
        ...
        mTextSelectSize = ta.getDimension(R.styleable.CommonTabLayout_tl_textSelectsize,sp2px(0));
        ...
        mIsWidthMatch = ta.getBoolean(R.styleable.CommonTabLayout_tl_is_width_match, false);
    ...
    private void addTab(final int position, View tabView) {
        ...
        //字体
//        tv_tab_title.setTypeface(TypefaceManager.getInstance().customFont);
        ...
        if(mIsWidthMatch)//width 撑死
        {
            ...
            if(mTabCount>0)
            {
                mTabWidth = SizeUtils.getDisplayWidth(mContext)/mTabCount;
            }
            if (mTabWidth > 0) {
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            tv_tab_title.setTypeface(
                i == mCurrentTab && mIndicatorSelectBoldEnable ? Typeface.DEFAULT_BOLD
                    : Typeface.DEFAULT);
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            tab_title.setTypeface(isSelect && mText_select_bold_enable ? Typeface.defaultFromStyle(Typeface.BOLD) : Typeface.defaultFromStyle(Typeface.NORMAL));
            if(i == mCurrentTab && mTextSelectSize != 0){
