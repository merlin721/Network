...
public class MathExtendUtils {
     ...
     * @param v1 被减数
     * @param v2 减数
     * @return 两个参数数学差，以double格式返回
     */
    public static double subtract2(String v1, String v2) {
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        return b1.subtract(b2).doubleValue();
    }
    ...
    public static int round(double mDouble){
        BigDecimal bigDecimal = new BigDecimal(mDouble).setScale(0, BigDecimal.ROUND_HALF_UP);
