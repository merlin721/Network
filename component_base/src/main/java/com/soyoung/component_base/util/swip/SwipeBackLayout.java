package com.soyoung.component_base.util.swip;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     */
    public static final int EDGE_LEFT = SwipeViewDragHelper.EDGE_LEFT;

    /**
     * Edge flag indicating that the right edge should be affected.
     */
    public static final int EDGE_RIGHT = SwipeViewDragHelper.EDGE_RIGHT;

    /**
     * Edge flag indicating that the bottom edge should be affected.
     */
    public static final int EDGE_BOTTOM = SwipeViewDragHelper.EDGE_BOTTOM;
     ...
     * fling/snap.
     */
    public static final int STATE_IDLE = SwipeViewDragHelper.STATE_IDLE;

    /**
     * A view is currently being dragged. The position is currently changing as
     * a result of user input or simulated user input.
     */
    public static final int STATE_DRAGGING = SwipeViewDragHelper.STATE_DRAGGING;

    /**
     * A view is currently settling into place as a result of a fling or
     * predefined non-interactive motion.
     */
    public static final int STATE_SETTLING = SwipeViewDragHelper.STATE_SETTLING;
    ...
    private SwipeViewDragHelper mDragHelper;
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mDragHelper = SwipeViewDragHelper.create(this, new ViewDragCallback());
     ...
     * callback's
     * {@link SwipeViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link SwipeViewDragHelper.Callback#onEdgeDragStarted(int, int)}
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mScrimOpacity > 0 && drawContent
            && mDragHelper.getViewDragState() != SwipeViewDragHelper.STATE_IDLE) {
    ...
    public void attachToActivity(Activity activity) {
        ...
        //        BitmapDrawable bd = new BitmapDrawable(getResources(), ImageUtils.readBitMap(mActivity,background));
        //        decorChild.setBackground(bd);
    ...
    private class ViewDragCallback extends SwipeViewDragHelper.Callback {
