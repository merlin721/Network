...
import com.soyoung.component_base.util.constant.PermissionConstants;
...
public final class PermissionUtils {
    ...
    public static List<String> transPermissionFormText(Context context, List<String> permissions) {
